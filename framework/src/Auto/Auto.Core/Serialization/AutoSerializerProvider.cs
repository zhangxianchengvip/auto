...
namespace Auto.Core.Serialization
{
    /// <summary>
    /// 序列化接口
    /// </summary>
    public class AutoSerializerProvider : IAutoSerializerProvider
    {
        /// <summary>
        /// 序列化
        /// </summary>
        ...
        /// <returns></returns>
        public string Serialize(object data, Type? type = default(Type))
        {
            return data == null ? null : type == null ? JsonSerializer.Serialize(data) : JsonSerializer.Serialize(data, type);
        }
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        public byte[] SerializeBytes(object data, Type? type = default(Type))
        {
            return data == null ? null : type == null ? JsonSerializer.SerializeToUtf8Bytes(data) : JsonSerializer.SerializeToUtf8Bytes(data, type);
        }
